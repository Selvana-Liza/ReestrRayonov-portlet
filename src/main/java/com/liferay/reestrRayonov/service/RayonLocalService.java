...
/**
 * Provides the local service interface for Rayon. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author liza
 * @see RayonLocalServiceUtil
...
public interface RayonLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link RayonLocalServiceUtil} to access the rayon local service. Add custom service methods to {@link com.liferay.reestrRayonov.service.impl.RayonLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */

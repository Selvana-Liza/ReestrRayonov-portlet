 ...
 * @generated
 */
public class RayonLocalServiceClp implements RayonLocalService {
    ...
    public RayonLocalServiceClp(InvokableLocalService invokableLocalService) {
        ...
        _methodName19 = "addRayon";

        _methodParameterTypes19 = new String[] {
                "java.lang.String", "int", "boolean"
            };

        _methodName20 = "getRayons";

        _methodParameterTypes20 = new String[] { "long" };

        _methodName21 = "getRayons";

        _methodParameterTypes21 = new String[] { "long", "int", "int" };

        _methodName22 = "getRayons";

        _methodParameterTypes22 = new String[] { "boolean" };

        _methodName23 = "getRayons";

        _methodParameterTypes23 = new String[] { "int" };

        _methodName24 = "getRayons";

        _methodParameterTypes24 = new String[] { "java.lang.String" };

        _methodName25 = "updateRayon";
    ...
    public com.liferay.reestrRayonov.model.Rayon addRayon(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(rayon) });
        } catch (Throwable t) {
        ...
        return (com.liferay.reestrRayonov.model.Rayon) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.liferay.reestrRayonov.model.Rayon createRayon(long rayonId) {
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { rayonId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.liferay.reestrRayonov.model.Rayon deleteRayon(long rayonId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { rayonId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.liferay.reestrRayonov.model.Rayon fetchRayon(long rayonId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { rayonId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.liferay.reestrRayonov.model.Rayon getRayon(long rayonId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { rayonId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.liferay.reestrRayonov.model.Rayon> getRayons(
        ...
        return (java.util.List<com.liferay.reestrRayonov.model.Rayon>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<com.liferay.reestrRayonov.model.Rayon> getRayons(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName22,
                    _methodParameterTypes22, new Object[] { archive });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.liferay.reestrRayonov.model.Rayon> getRayons(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName23,
                    _methodParameterTypes23, new Object[] { kod });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
